...
public class FunctionalLibrary extends ReusableLibrary {
	 ...
	 * 
	 * // The login succeeds if the flight finder page is displayed // Hence no
	 * further verification is required report.updateTestLog("Verify Login",
	 * "Login succeeded for valid user", Status.PASS);
	 * 
	 * signOnPage = flightFinderPage.logout(); return signOnPage; } //
	 */
}